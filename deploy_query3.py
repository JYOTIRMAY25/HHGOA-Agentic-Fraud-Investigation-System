#!/usr/bin/env python3
"""Deploy shortestPath query with FOR GRAPH syntax."""
import os
...
# Try FOR GRAPH syntax
query = """CREATE QUERY shortestPath(STRING start_txn_id, STRING end_txn_id) FOR GRAPH HHGOA_Fraud_Graph {
...
print("Deploying with FOR GRAPH syntax...")
try:
    r = conn.gsql(query)
    print(f"Result: {r}")
