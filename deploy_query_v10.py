#!/usr/bin/env python3
"""Deploy shortestPath with correct edge syntax."""
import os
...
# Fix: use *:1..10 syntax for variable-length edges
query = (
    ...
    f"    Tgt = SELECT t FROM Src:s -(NEXT_TRANSACTION*:1..10)-> t WHERE t.transaction_id == end_txn_id\n"
